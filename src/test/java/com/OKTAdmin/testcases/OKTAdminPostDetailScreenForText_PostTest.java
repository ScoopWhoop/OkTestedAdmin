...
public class OKTAdminPostDetailScreenForText_PostTest extends TestBase {
	...
	public void Verify_Multiple_Validation_For_Text_Post() throws InterruptedException {
		...
		sa.assertEquals(Validation_DescriptionCannotBeBlank, "Description can not be blank",
				"Description can not be blank validation is missing");
		Thread.sleep(5000);
		sa.assertAll();
	...
	public void CreateAndUpdate_Text_Post() throws InterruptedException {
		...
		String Verify_Audio_Post_Name_OR_Description_On_Post_List = OKTADPDSTP
				.Text_Post_Name_OR_Description_On_Post_List();
		...
		String Verify_Audio_Post_Community_Name_Label_On_Post_List = OKTADPDSTP
				.Text_Post_Community_Name_Label_On_Post_List();
