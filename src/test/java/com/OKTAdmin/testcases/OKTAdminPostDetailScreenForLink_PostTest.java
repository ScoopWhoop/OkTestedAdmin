...
public class OKTAdminPostDetailScreenForLink_PostTest extends TestBase {
	...
	public void Verify_Validation_Link_Post() throws InterruptedException {
		...
		sa.assertEquals(Validation_LinkCannotBeBlank, "link can not be blank",
				"Link can not be blank validation is missing");
		Thread.sleep(5000);
		sa.assertAll();
	...
	public void CreateAndUpdate_Link_Post() throws InterruptedException {
		...
		String Verify_Link_Post_Name_OR_Description_On_Post_List = OKTADPDSLP
				.Link_Post_Name_OR_Description_On_Post_List();
		...
		String Verify_Link_Post_Community_Name_Label_On_Post_List = OKTADPDSLP
				.Link_Post_Community_Name_Label_On_Post_List();
