...
public class OKTAdminPostDetailScreenForVideo_PostTest extends TestBase {
	...
	public void CreateAndUpdate_Video_Post() throws InterruptedException, AWTException {
		...
		String Verify_Video_Post_Name_OR_Description_On_Post_List = OKTADDSVP
				.Video_Post_Name_OR_Description_On_Post_List();
		...
		String Verify_Video_Post_Community_Name_Label_On_Post_List = OKTADDSVP
				.Video_Post_Community_Name_Label_On_Post_List();
