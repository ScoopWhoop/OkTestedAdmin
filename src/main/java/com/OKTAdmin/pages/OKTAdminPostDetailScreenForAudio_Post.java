...
public class OKTAdminPostDetailScreenForAudio_Post extends TestBase {
    ...
    WebElement Attachment_Media_Label;
    
    @FindBy(xpath = "//label[text()='Thumbnail']")
    WebElement Attachment_Thumbnail_Label;
    ...
    @FindBy(xpath ="//div[@class='text-center col']//audio")
	...
	public String Attachment_Media_Label() throws InterruptedException
	{
		 Thread.sleep(5000);
		 return Attachment_Media_Label.getText();
	}
	

	public String Attachment_Thumbnail_Label() throws InterruptedException
	{
		 Thread.sleep(5000);
		 return Attachment_Thumbnail_Label.getText();
	}
